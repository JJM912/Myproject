...
1. Read a passage about photographs that brought about major social changes and identify the main ideas and supporting details.
2. Understand and apply reading strategies such as identifying main ideas, finding evidence, noticing grammar/structure, and marking confusing parts.
3. Learn key vocabulary from the passage and identify words they need to review individually.
4. Explore the passage actively through sentence-level tagging, highlighting, written comments, and group discussion.
5. Compare their interpretations with classmates and refine their understanding through peer and teacher feedback.
...
| Time | Stage | Teacher Role | Student Activities | App Use |
|---|---|---|---|---|
| 0–5 min | Warm-up and lesson introduction | Introduces the topic, activates background knowledge, and explains the lesson goal | Think about how images can influence emotions or social change | Home screen is displayed |
| 5–15 min | Vocabulary learning | Presents target words, gives thinking time, flips cards, and guides individual responses | Think about word meanings, check meanings and definitions, select I Know It or Save to My Words | Word section: teacher controls cards; students build personal word lists |
| 15–20 min | Reading strategy guidance | Explains how to tag sentences by purpose: main idea, evidence, grammar/structure, or unclear parts | Review the tag categories and understand the reading task | Reading section: tag categories are introduced |
| 20–27 min | Individual reading and exploration | Facilitates independent reading and monitors student progress | Read the passage, highlight sentences, choose tags, and write opinions or questions | Reading section: students create individual highlights and comments |
| 27–40 min | Class highlights opened and group discussion | Opens class highlights, facilitates peer interaction, and encourages evidence-based discussion | Observe class-wide tags and comments, compare evidence, and refine interpretations in groups | Teacher Settings: Share Class Highlights; students refer to individual and class-shared responses |
...
- “Can a photograph change people’s minds?”
- “Have you ever seen a picture that made you feel strongly about an issue?”
...
After students have had time to think, the teacher flips the card. Students then check the Korean meaning and the English definition or example shown on the card. After checking the word, each student makes an individual choice:

- **I Know It** if they understand the word
- **Save to My Words** if they do not know the word well or want to review it later
...
- **Main idea:** sentences that show the central message of the passage
- **Evidence for questions:** sentences that help answer the reading questions
- **Grammar/structure:** sentences that contain important grammar or sentence structure
- **I do not understand:** sentences that are confusing or need further explanation
...
For each important sentence, students:

1. Choose a tag category.
2. Observe the sentence highlighted in the color of the selected category.
3. Write a short opinion, reason, or question in the comment box.
...
Students immediately use the shared results for pair or group discussion. They compare their own tags with the class-wide highlights and discuss the reasons behind different choices. During this activity, students notice:

- Which sentences many students marked as important
- Which sentences were used as evidence
- Which grammar or structure points were noticed
- Which sentences were confusing to classmates
- How classmates explained their choices

They also discuss questions such as:

- Which sentence best shows the main idea?
- Which sentence provides evidence for Q1 or Q2?
- Which sentence was difficult to understand?
- What grammar or sentence structure is worth noticing?
- How does the image of the burning Cuyahoga River affect readers?
...
- Connecting student responses to the reading questions
...
Students complete a brief formative check, such as answering one question orally, writing a one-sentence summary, or explaining one sentence they highlighted.
...
- Think about the meanings of key vocabulary before checking the answers.
- Learn key vocabulary through teacher-controlled word cards.
- Select **I Know It** or **Save to My Words** for each word.
- Save difficult vocabulary to **My Words** for after-class review.
- Remove saved words after reviewing and memorizing them.
- Read the passage individually.
- Highlight and tag sentences based on reading strategy categories.
- Write comments, reasons, or questions next to sentences.
- Compare their individual responses with class-shared highlights.
- Discuss their interpretations with peers using both individual and shared class responses.
...
The teacher functions as both a **facilitator** and a **knowledge provider**.

As a facilitator, the teacher supports students’ individual exploration, encourages group discussion, and helps students compare different interpretations.

As a knowledge provider, the teacher clarifies important vocabulary, reading details, grammar points, and the overall meaning of the passage. The teacher also ensures that all students have access to essential content knowledge.
...
- Vocabulary responses in the Word section
- Words saved to My Words
- Sentence-level tags and highlights
- Student comments and questions
- Group discussion
- Whole-class sharing
- Short oral or written review at the end of the lesson

Feedback includes both **peer feedback** and **teacher feedback**. Peer feedback occurs during the class-highlight-based group discussion, while teacher feedback occurs during the final whole-class sharing stage.
...
- Build a personal vocabulary review list based on their own needs.
- Review difficult words after class and remove them after memorization.
- Understand the main ideas and details of the passage.
- Apply reading strategies to sentence-level comprehension.
- Participate more actively in reading and discussion.
- Understand the passage from multiple perspectives.
